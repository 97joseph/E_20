...
first:
    lw $1, 7($0)       # read from address var1 + 0
    lw $2, 8($0)       # read from address var2 + 0
    and $3, $1, $2     # AND the values together
    or $4, $1, $2      # then OR them together
    sw $3, 9($0)       # write the AND result into memory
    movi $5, 9         # put the address (not the value!) in $5
...
#--
#--MACHINE CODE
# ram[0] = 16'b1000000010000111;		// first: lw $1,7($0)
# ram[1] = 16'b1000000100001000;		// lw $2,8($0)
# ram[2] = 16'b0000010100110010;		// and $3,$1,$2
# ram[3] = 16'b0000010101000011;		// or $4,$1,$2
# ram[4] = 16'b1010000110001001;		// sw $3,9($0)
# ram[5] = 16'b0010001010001001;		// movi $5,9
# ram[6] = 16'b0100000000000110;		// halt 
# ram[7] = 16'b0000000000011110;		// var1: .fill 30
# ram[8] = 16'b0000000000000101;		// var2: .fill 5
# ram[9] = 16'b0000000000000000;		// var3: .fill first
#--
#--
#--EXECUTION OUTPUT
# Final state:
